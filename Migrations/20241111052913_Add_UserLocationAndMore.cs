...
{
    public partial class Add_UserLocationAndMore : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Properties_PropertyLocation_PropertyLocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Halls_Properties_PropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HallAmenityMappers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HallAmenityMappers_Amenities_AmenityId",
                        column: x => x.AmenityId,
                        principalTable: "Amenities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HallAmenityMappers_Halls_HallId",
                        column: x => x.HallId,
                        principalTable: "Halls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeSlotMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimeSlotMappings_Halls_HallId",
                        column: x => x.HallId,
                        principalTable: "Halls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimeSlotMappings_TimeSlots_TimeSlotId",
                        column: x => x.TimeSlotId,
                        principalTable: "TimeSlots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HallAmenityMappers_AmenityId",
                table: "HallAmenityMappers",
                column: "AmenityId");

            migrationBuilder.CreateIndex(
                name: "IX_HallAmenityMappers_HallId",
                table: "HallAmenityMappers",
                column: "HallId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeSlotMappings_HallId",
                table: "TimeSlotMappings",
                column: "HallId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSlotMappings_TimeSlotId",
                table: "TimeSlotMappings",
                column: "TimeSlotId");
        }
